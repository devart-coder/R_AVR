...
use crate::mcu::registers::tccr0b::Tccr0bBuilder;
use crate::mcu::registers::tccr1a::Tccr1aBuilder;
use crate::mcu::registers::tccr1b::Tccr1bBuilder;
...
impl<const N: u8> Settings<N> {
    ...
    pub fn prescaling(&mut self, p: Prescaling) {
        let value: u8 = match p {
            ...
            //TODO::applyImpl
            Prescaling::ExternalClockFalling => match N {
                _ => 0u8,
            },
            //TODO::applyImpl
            Prescaling::ExternalClockRising => match N {
                _ => 0u8,
            },
        };
